...
en: {
  ...
  bsTitleFor:"Script {n}",
  bsSub:"One rule per line. The site runs them for you, even while you are away.",
  bsPersona:"Voice",
  bsNormal:"Normal",
  bsAnime:"Anime",
  bsPersonaHint:"The voice picks the bot’s own words for joins and events. Your rules are always said exactly as you wrote them.",
  bsLabel:"Rules",
  bsExample:"Load an example",
  bsSave:"Save",
  bsSaved:"Bot script saved ✓",
  bsHelp:"when hello: hi {name}~   ·   command roll: {name} rolled {roll}   ·   on join: welcome {name}\nBlanks you can use: {name} {server} {roll}",
  ...
  bsUnknownWord:"I don’t know what “{w}” is. Rules start with when, command, on join or event ping.",
  bsNeedOne:"Write at least one rule.",
...
es: {
  ...
  bsSub:"Una regla por línea. La web las ejecuta por ti, aunque no estés.",
  bsPersona:"Voz",
  bsNormal:"Normal",
  bsAnime:"Anime",
  bsPersonaHint:"La voz decide las palabras propias del bot al entrar alguien y en los eventos. Tus reglas se dicen siempre tal cual las escribiste.",
  bsLabel:"Reglas",
  bsExample:"Cargar un ejemplo",
  bsSave:"Guardar",
  bsSaved:"Script del bot guardado ✓",
  bsHelp:"when hola: hola {name}~   ·   command roll: {name} sacó {roll}   ·   on join: bienvenido {name}\nHuecos que puedes usar: {name} {server} {roll}",
  ...
  bsUnknownWord:"No sé qué es “{w}”. Las reglas empiezan por when, command, on join o event ping.",
  bsNeedOne:"Escribe al menos una regla.",
...
fr: {
  ...
  bsSub:"Une règle par ligne. Le site les applique pour toi, même en ton absence.",
  bsPersona:"Voix",
  bsNormal:"Normale",
  bsAnime:"Anime",
  bsPersonaHint:"La voix choisit les mots du bot pour les arrivées et les événements. Tes règles sont toujours dites telles que tu les as écrites.",
  bsLabel:"Règles",
  bsExample:"Charger un exemple",
  bsSave:"Enregistrer",
  bsSaved:"Script du bot enregistré ✓",
  bsHelp:"when bonjour: salut {name}~   ·   command roll: {name} a fait {roll}   ·   on join: bienvenue {name}\nChamps disponibles : {name} {server} {roll}",
  ...
  bsUnknownWord:"Je ne sais pas ce qu’est « {w} ». Les règles commencent par when, command, on join ou event ping.",
  bsNeedOne:"Écris au moins une règle.",
...
pt: {
  ...
  bsTitle:"Programar este bot",
  bsTitleFor:"Programar {n}",
  bsSub:"Uma regra por linha. O site as executa por você, mesmo quando você não está.",
  bsPersona:"Voz",
  bsNormal:"Normal",
  bsAnime:"Anime",
  bsPersonaHint:"A voz escolhe as palavras do próprio bot para entradas e eventos. Suas regras são sempre ditas exatamente como você escreveu.",
  bsLabel:"Regras",
  bsExample:"Carregar um exemplo",
  bsSave:"Salvar",
  bsSaved:"Script do bot salvo ✓",
  bsHelp:"when oi: oi {name}~   ·   command roll: {name} tirou {roll}   ·   on join: bem-vindo {name}\nCampos que você pode usar: {name} {server} {roll}",
  ...
  bsUnknownWord:"Não sei o que é “{w}”. As regras começam com when, command, on join ou event ping.",
  bsNeedOne:"Escreva pelo menos uma regra.",
